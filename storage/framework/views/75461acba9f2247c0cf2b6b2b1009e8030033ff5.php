        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title"><?php echo e(isset($doctor) ? 'Edit Doctor Info' : 'Add Doctor'); ?></h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="email" class="form-control" type="text" name="email"
                                               value="<?php echo e(isset($doctor) ? $doctor->email : ''); ?>">
                                    </div>
                                </div>
                                <?php if(!isset($doctor)): ?>
                                    <div class="form-group">
...
<?php echo $__env->make('users.admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HOSPITAL MANAGEMENT SYSTEM PROJECT IN LARAVEL\resources\views/users/doctors/create.blade.php ENDPATH**/ ?>
        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title"><?php echo e(isset($nurse) ? 'Edit Nurse Info' : 'Add Nurse'); ?></h3>
                ...
                <div class="offset-2 col-md-8">
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    <?php echo e(isset($nurse) ? 'Edit Nurse Info' : 'Add Nurse'); ?>
                        ...
                        <form class="kt-form kt-form--label-right"
                              action="<?php echo e(isset($nurse) ? route('nurses.update',$nurse->id) : route('nurses.store')); ?>"
                              method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
                                            <div class="kt-avatar__holder" <?php if(isset($nurse)): ?> <?php if(strpos($nurse->picture,'users_pictures')!==false): ?> style="background-image: url(<?php echo e(asset('storage/'.$nurse->picture)); ?>)" <?php else: ?> style="background-image: url(<?php echo e($nurse->picture); ?>)" <?php endif; ?>  <?php else: ?> style="background-image: url(&quot;http://keenthemes.com/metronic/preview/default/custom/user/assets/media/users/300_20.jpg&quot;);" <?php endif; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="first_name" class="form-control" type="text" name="first_name"
                                               value="<?php echo e(isset($nurse) ? $nurse->first_name : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="last_name" class="form-control" type="text" name="last_name"
                                               value="<?php echo e(isset($nurse) ? $nurse->last_name : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="national_id" class="form-control" type="text" name="national_id"
                                               value="<?php echo e(isset($nurse) ? $nurse->national_id : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="address" id="address" cols="30"
                                                  rows="5"><?php echo e(isset($nurse) ? $nurse->address : ''); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <div class="input-group">
                                        ...
                                        <input id="email" class="form-control" type="text" name="email"
                                               value="<?php echo e(isset($nurse) ? $nurse->email : ''); ?>">
                                    </div>
                                </div>
                                <?php if(!isset($nurse)): ?>
                                    <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                                            <input type="text" class="form-control" readonly="" name="birth_date" id="date"
                                               value="<?php echo e(isset($nurse) ? $nurse->birth_date : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Gender</label>
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="gender" id="gender">
                                            ...
                                            <option
                                                value="male" <?php if(isset($nurse)): ?> <?php echo e($nurse->gender == 'male' ? 'selected' : ''); ?> <?php endif; ?>>
                                                male
                                            </option>
                                            <option
                                                value="female" <?php if(isset($nurse)): ?> <?php echo e($nurse->gender == 'female' ? 'selected' : ''); ?> <?php endif; ?>>
                                                female
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="phone" class="form-control" type="number" name="phone"
                                               value="<?php echo e(isset($nurse) ? $nurse->phone : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="mobile" class="form-control" type="number" name="mobile"
                                               value="<?php echo e(isset($nurse) ? $nurse->mobile : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="emergency" class="form-control" type="number" name="emergency"
                                               value="<?php echo e(isset($nurse) ? $nurse->emergency : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="kt_select2_3" class="kt-select2 form-control" name="departments[]" id="departments" multiple>
                                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($department->id); ?>" <?php if(isset($nurse)): ?> <?php echo e($nurse->hasDepartment($department->id) ? 'selected' : ''); ?> <?php endif; ?>>
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="<?php echo e(isset($nurse) ? 'Update' : 'Submit'); ?>"
...
<?php echo $__env->make('users.admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\HOSPITAL-MANAGEMENT- LARAVEL\resources\views/users/nurses/create.blade.php ENDPATH**/ ?>
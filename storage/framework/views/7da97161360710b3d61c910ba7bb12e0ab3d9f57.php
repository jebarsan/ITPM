        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title"><?php echo e(isset($timeschedule) ? 'Edit Time Schedule Info' : 'Add Time Schedule'); ?></h3>
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    <?php echo e(isset($timeschedule) ? 'Edit Time Schedule Info' : 'Add Time Schedule'); ?>
                        ...
                        <form id="timescheduleform"
                            class="kt-form kt-form--label-right"
                              action="<?php echo e(isset($timeschedule) ? route('timeschedules.update',$timeschedule->id) : route('timeschedules.store')); ?>"
                              method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control timepicker" id="start_time" name="start_time" readonly
                                               placeholder="Select time" type="text" <?php if(isset($timeschedule)): ?> value="<?php echo e($timeschedule->start_time); ?>"<?php endif; ?>>
                                ...
                                <div class="form-group" id="endtimeDiv" style="display:none;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control timepicker" id="end_time" name="end_time" readonly
                                               placeholder="Select time" type="text" <?php if(isset($timeschedule)): ?> value="<?php echo e($timeschedule->end_time); ?>"<?php endif; ?>>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="week_day" id="week_day">
                                            <option
                                                value="saturday" <?php if(isset($timeschedule)): ?> <?php echo e($timeschedule->week_day == 'saturday' ? 'selected' : ''); ?> <?php endif; ?>>
                                                Saturday
                                            </option>
                                            <option
                                                value="sunday" <?php if(isset($timeschedule)): ?> <?php echo e($timeschedule->week_day == 'sunday' ? 'selected' : ''); ?> <?php endif; ?>>
                                                Sunday
                                            </option>
                                            <option
                                                value="monday" <?php if(isset($timeschedule)): ?> <?php echo e($timeschedule->week_day == 'monday' ? 'selected' : ''); ?> <?php endif; ?>>
                                                Monday
                                            </option>
                                            <option
                                                value="tuesday" <?php if(isset($timeschedule)): ?> <?php echo e($timeschedule->week_day == 'tuesday' ? 'selected' : ''); ?> <?php endif; ?>>
                                                Tuesday
                                            </option>
                                            <option
                                                value="wednesday" <?php if(isset($timeschedule)): ?> <?php echo e($timeschedule->week_day == 'wednesday' ? 'selected' : ''); ?> <?php endif; ?>>
                                                Wednesday
                                            </option>
                                            <option
                                                value="thursday" <?php if(isset($timeschedule)): ?> <?php echo e($timeschedule->week_day == 'thursday' ? 'selected' : ''); ?> <?php endif; ?>>
                                                Thursday
                                            </option>
                                            <option
                                                value="friday" <?php if(isset($timeschedule)): ?> <?php echo e($timeschedule->week_day == 'friday' ? 'selected' : ''); ?> <?php endif; ?>>
                                                Friday
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="<?php echo e(isset($timeschedule) ? 'Update' : 'Submit'); ?>"
    ...
    <script>
        ...
        $("#usertype").change(function () {
            ...
            if ($(this).val() == ''){
                ...
                $.ajax({
                    url: "<?php echo e(route('get-user-by-user-type')); ?>?usertype=" + $(this).val(),
                    method: 'GET',
...
<?php echo $__env->make('users.admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\HOSPITAL-MANAGEMENT- LARAVEL\resources\views/timeschedules/create.blade.php ENDPATH**/ ?>
        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <span class="kt-subheader__desc">Nurse</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{route('nurses.edit',$nurse->id)}}"><i
                                                class="fa fa-edit"></i>Edit Details</a>
                                        <a class="dropdown-item" href="{{route('treatment-history',$nurse->id)}}"><i class="fa fa-clock"></i>Treatment History</a>
                                        <a href="{{route('nurses.show',$nurse->id)}}" class="dropdown-item"><i

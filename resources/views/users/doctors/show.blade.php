        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <span class="kt-subheader__desc">Employees</span>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="kt-widget kt-widget--user-profile-2">
                                    ...
                                    <div class="kt-widget__content">
                                        <div class="kt-widget__stats kt-margin-r-20">
                                            ...
                                            <div class="kt-widget__details">
                                                ...
                                                <span class="kt-widget__value"><span></span>675</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="kt-widget__stats">
                                            <div class="kt-widget__icon">
                                                <i class="
                                                flaticon-stopwatch"></i>
                                            </div>
                                            <div class="kt-widget__details">
                                                <span class="kt-widget__title">Working Hours</span>
                                                <span class="kt-widget__value"><span></span>50 h/w</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="kt-widget__footer">
                                    <button type="button" class="btn btn-label-success btn-lg btn-upper">Generate PDF Report </button>
                                </div>
                                <div class="kt-widget__footer">
                                    <button type="button" class="btn btn-label-success btn-lg btn-upper">Generate EXCEL Report</button>
                                </div>
                            </div>
                            <!--end::Widget -->

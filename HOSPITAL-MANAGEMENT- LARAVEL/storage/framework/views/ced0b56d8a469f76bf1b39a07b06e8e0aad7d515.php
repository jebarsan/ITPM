        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title"><?php echo e(isset($category) ? 'Edit Medicine Category Info' : 'Add Medicine Category'); ?></h3>
                ...
                <div class="offset-2 col-md-8">
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    <?php echo e(isset($category) ? 'Edit Medicine Category Info' : 'Add Medicine Category'); ?>
                        ...
                        <form class="kt-form kt-form--label-right"
                              action="<?php echo e(isset($category) ? route('medicines.categories.update',$category->id) : route('medicines.categories.store')); ?>"
                              method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="description" id="description" cols="30"
                                                  rows="5"><?php echo e(isset($category) ? $category->description : ''); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="<?php echo e(isset($category) ? 'Update' : 'Submit'); ?>"
...
<?php echo $__env->make('users.admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\HOSPITAL-MANAGEMENT- LARAVEL\resources\views/medicines/categories/create.blade.php ENDPATH**/ ?>
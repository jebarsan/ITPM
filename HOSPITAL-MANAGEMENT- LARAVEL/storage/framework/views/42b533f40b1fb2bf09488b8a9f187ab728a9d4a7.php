<?php $__env->startSection('styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(url('select2/dist/css/select2.min.css')); ?>">
        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title"><?php echo e(isset($appointment) ? 'Edit Appointment Info' : 'Add Appointment'); ?></h3>
                ...
                <div class="offset-2 col-md-8">
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    <?php echo e(isset($appointment) ? 'Edit Appointment Info' : 'Add Appointment'); ?>
                        ...
                        <form class="kt-form kt-form--label-right"
                              action="<?php echo e(isset($appointment) ? route('appointments.update',$appointment->id) : route('appointments.store')); ?>"
                              method="POST"
                                        ...
                                        <?php if(isset($patients)): ?>
                                            <select class="form-control" name="patient" id="patient">
                                                ...
                                                <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($patient->id); ?>" <?php if(isset($appointment)): ?> <?php echo e($patient->id == $appointment->patient_id ? 'selected' : ''); ?> <?php endif; ?>><?php echo e($patient->first_name.''.$patient->last_name); ?></option>
                                        ...
                                        <?php if(isset($departments)): ?>
                                            <select class="form-control" name="department" id="department">
                                                ...
                                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($department->id); ?>" <?php if(isset($appointment)): ?> <?php echo e($department->id == $appointment->department_id ? 'selected' : ''); ?> <?php endif; ?>><?php echo e($department->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="form-group" id="dateDiv" style="display: none">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="date" id="date" readonly
                                               ...
                                               <?php if(isset($appointment)): ?> value="<?php echo e($appointment->date); ?>"<?php endif; ?>>
                                    </div>
                                </div>
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="<?php echo e(isset($appointment) ? 'Update' : 'Submit'); ?>"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        $("#department").change(function () {
            $.ajax({
                url: "<?php echo e(route('get-doctors-by-department')); ?>?id=" + $(this).val(),
                method: 'GET',
        ...
        $("#doctor").change(function () {
            ...
            $.ajax({
                url: "<?php echo e(route('get-payment-item-by-doctor_id')); ?>?doctor=" + $('#doctor').val(),
                method: 'GET',
                success: function (data) {
            ...
            $.ajax({
                url: "<?php echo e(route('get-time-schedule-by-doctor')); ?>?id=" + $(this).val(),
                method: 'GET',
                success: function (data) {
                    $('#dateDiv').show();
        ...
        $("#date").change(function () {
            ...
            $.ajax({
                url: "<?php echo e(route('get-appointments-by-date')); ?>?date=" + $(this).val(),
                method: 'GET',
                success: function (data) {
            ...
            $.ajax({
                url: "<?php echo e(route('get-dayoff-schedule-by-doctor')); ?>?id=" + $("#doctor").val(),
                method: 'GET',
                success: function (data) {
                    check = 0;
                    ...
                    if (check == 1) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('get-time-by-time-schedule')); ?>?week_num=" + date.day() + "&doctor_id=" + $('#doctor').val(),
                            method: 'GET',
                            success: function (data) {
...
<?php echo $__env->make('users.admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HOSPITAL MANAGEMENT SYSTEM PROJECT IN LARAVEL\resources\views/appointments/create.blade.php ENDPATH**/ ?>
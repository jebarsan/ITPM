        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title"><?php echo e(isset($bedallotment) ? 'Edit Bed Allotment Info' : 'Add Bed Allotment'); ?></h3>
                ...
                <div class="offset-2 col-md-8">
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    <?php echo e(isset($bedallotment) ? 'Edit Bed Allotment Info' : 'Add Bed Allotment'); ?>
                        ...
                        <form class="kt-form kt-form--label-right"
                              action="<?php echo e(isset($bedallotment) ? route('bedallotments.update',$bedallotment->id) : route('bedallotments.store')); ?>"
                              method="POST"
                                        ...
                                        <?php if(isset($patients)): ?>
                                            <select class="form-control" name="patient" id="patient">
                                                ...
                                                <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($patient->id); ?>" <?php if(isset($bedallotment)): ?> <?php echo e($patient->id == $bedallotment->patient_id ? 'selected' : ''); ?> <?php endif; ?>><?php echo e($patient->first_name); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="start_date" class="form-control datepicker allotment" type="text" name="start_date"
                                               value="<?php echo e(isset($bedallotment) ? $bedallotment->start_date : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="start_time" class="form-control timepicker allotment" type="text" name="start_time"
                                               value="<?php echo e(isset($bedallotment) ? $bedallotment->start_time : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="end_date" class="form-control datepicker allotment" type="text" name="end_date"
                                               value="<?php echo e(isset($bedallotment) ? $bedallotment->end_date : ''); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="end_time" class="form-control timepicker allotment" type="text" name="end_time"
                                               value="<?php echo e(isset($bedallotment) ? $bedallotment->end_time : ''); ?>">
                                    </div>
                                </div>
                                        ...
                                        <?php if(isset($beds)): ?>
                                            <select class="form-control" name="bed" id="bed" >
                                                ...
                                                <?php $__currentLoopData = $beds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($bed->id); ?>" <?php if(isset($bedallotment)): ?> <?php echo e($bed->id == $bedallotment->bed_id ? 'selected' : ''); ?> <?php endif; ?>><?php echo e($bed->code); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        <?php endif; ?>
                                    </div>
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="<?php echo e(isset($bedallotment) ? 'Update' : 'Submit'); ?>"
    ...
    <script>
        $(".allotment").change(function () {
           ...
           // alert(start_date_time);
            ...
            $.ajax({
                url: "<?php echo e(route('get-bedallotments-by-date')); ?>?start=" + start_date_time +"&end=" + end_date_time,
                method: 'GET',
...
<?php echo $__env->make('users.admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\HOSPITAL-MANAGEMENT- LARAVEL\resources\views/bedallotments/create.blade.php ENDPATH**/ ?>
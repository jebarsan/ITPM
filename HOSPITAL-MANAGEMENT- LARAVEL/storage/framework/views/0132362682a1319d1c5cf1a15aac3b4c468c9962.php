                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo e(route('patients.create')); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <div class="kt-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable  kt_table_1" id="kt_table_1">
                        ...
                        <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <?php if(strpos($patient->picture,'users_pictures')!==false): ?>
                                        <img src="<?php echo e(asset('storage/'.$patient->picture)); ?>" width="50px"
                                             height="50px">
                                    <?php else: ?>
                                        <img src="<?php echo e($patient->picture); ?>" width="50px" height="50px">
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <?php $__currentLoopData = $patient->departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $de): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="<?php echo e(route('patients.edit',$patient->id)); ?>"><i
                                                class="fa fa-edit"></i>Edit Details</a>
                                        <a href="<?php echo e(route('patients.show',$patient->id)); ?>" class="dropdown-item"><i
...
<?php echo $__env->make('users.admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel-Hospital-Management-System-master\resources\views/users/patients/list.blade.php ENDPATH**/ ?>